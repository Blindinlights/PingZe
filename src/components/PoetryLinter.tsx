  ...
  return (
    <div className="flex flex-col h-full space-y-8">
      ...
      <div className="bg-paper shadow-lg rounded-sm relative overflow-hidden">
        {/* 卷轴装饰边 */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#d6a45e] via-[#c04851] to-[#d6a45e]">
        </div>
        <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-[#d6a45e]/50 to-transparent">
        </div>
        ...
        <div className="p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-3">
              ...
              <label className="font-semibold text-[#1a1a1a] tracking-[0.15em] text-lg">
                词牌
              </label>
            </div>
            ...
            <div className="relative" ref={cipaiRef}>
              <button
                ...
                type="button"
              >
                <span className="font-serif text-xl text-[#1a1a1a] tracking-[0.1em]">
                  {selectedCipai.name}
                </span>
                <span
                  className={`text-[#d6a45e] transition-transform duration-300 group-hover:text-[#c04851] ${
          ...
          <div className="flex items-center flex-wrap gap-4">
            {validation &&
              Object.entries(validation.rhymeGroups).map(([id, group]) => (
                <div
                  key={id}
                  className="flex items-center space-x-2 bg-[#f5f3f0] px-4 py-2 rounded-sm border border-[#d6a45e]/30"
                >
                  <span
                  ...
                  <span className="font-serif text-[#1a1a1a] text-sm">
                    {parseInt(id) === 0
                      ? (
                        <span className="text-[#c04851] font-semibold">
                          主韵
                        </span>
                      )
                      : (
            ...
            {(!validation ||
              ...
              <span className="text-[#2b2b2b]/40 italic text-sm">
                请输入诗词以查看韵部
              </span>
            )}
          </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/3 flex flex-col relative">
          <div className="bg-[#faf9f6] shadow-lg rounded-sm overflow-hidden border border-[#e8e4dc] relative min-h-[600px]">
            {/* 竖线装饰 */}
            <div className="absolute top-0 left-8 w-px h-full bg-gradient-to-b from-[#d6a45e]/40 via-[#d6a45e]/20 to-[#d6a45e]/40">
            </div>
            <div className="absolute top-0 right-8 w-px h-full bg-gradient-to-b from-[#d6a45e]/40 via-[#d6a45e]/20 to-[#d6a45e]/40">
            </div>
            ...
            <div className="absolute top-4 right-4 w-12 h-12 border-2 border-[#c04851]/20 rounded-sm flex items-center justify-center transform rotate-12 pointer-events-none">
              <span className="text-[#c04851]/40 text-[10px] font-bold tracking-widest">
                诗词
              </span>
            </div>
          ...
          <div className="mt-4 flex justify-center">
            <div className="flex items-center space-x-3 text-[#2b2b2b]/40 text-xs tracking-[0.2em]">
              <div className="w-8 h-px bg-gradient-to-r from-transparent to-[#d6a45e]/50">
              </div>
              <span>输入诗词内容进行格律检测</span>
              <div className="w-8 h-px bg-gradient-to-l from-transparent to-[#d6a45e]/50">
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-2/3 bg-[#faf9f6] shadow-lg rounded-sm border border-[#e8e4dc] relative overflow-hidden min-h-[600px]">
          {/* 顶部装饰条 */}
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#7f8c5b] via-[#4e7ca1] to-[#7f8c5b]">
          </div>
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {toneErrors > 0 && (
                          <span className="inline-flex items-center px-3 py-1 bg-[#4e7ca1]/10 rounded text-sm">
                            <span className="w-2.5 h-2.5 bg-[#4e7ca1] rounded-sm mr-2">
                            </span>
                            平仄 {toneErrors}
                          </span>
                        )}
                        {rhymeErrors > 0 && (
                          <span className="inline-flex items-center px-3 py-1 bg-[#c04851]/10 rounded text-sm">
                            <span className="w-2.5 h-2.5 bg-[#c04851] rounded-sm mr-2">
                            </span>
                            韵脚 {rhymeErrors}
                          </span>
                        )}
                ...
                (lineSchema: LineSchema, lineIdx: number) => {
                  ...
                  return (
                    ...
                    >
                        ...
                        (slotSchema: SlotSchema, slotIdx: number) => {
                          ...
                          if (slotResult) {
                            ...
                            if (slotResult.isToneError) {
                              ...
                              bgClass =
                                "bg-gradient-to-br from-[#f9e3e5] to-[#f3d5d8]";
                          ...
                          return (
                            ...
                            >
                              ...
                              {slotResult?.isPolyphonic && (
                                <div className="absolute top-1 right-1 w-2 h-2 rounded-full bg-gradient-to-br from-[#6b5b95] to-[#5a4a7a] opacity-70">
                                </div>
                              )}
                      ...
                      {overflow && (
                        <div
                          className="inline-flex items-center text-[#c04851] font-semibold bg-gradient-to-r from-[#fef5f6] to-[#fdf0f2] px-4 py-2 rounded-sm border border-[#c04851]/30 shadow-sm"
                          title="超出字数"
                        >
          ...
          {/* 底部装饰 */}
          <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-[#7f8c5b]/40 to-transparent">
          </div>
        </div>
      </div>
    </div>

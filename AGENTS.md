...
- Strict typing with explicit interfaces (`Cipai`, `LineSchema`,
  `ValidationResult`)
...
- **Files:** Match export name (e.g., `prosody-engine.ts` exports
  `validatePoem`)
...
- **Rhyme Inference:** Rhyme groups inferred from majority vote at rhyme
  positions
